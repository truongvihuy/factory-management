...
export const envValidationSchema = Joi.object({
  ...
  PASSWORD_MEMORY_COST: Joi.number().integer().min(8).default(65536),
  PASSWORD_TIME_COST: Joi.number().integer().min(1).default(3),
  PASSWORD_PARALLELISM_COST: Joi.number().integer().min(1).default(1),
